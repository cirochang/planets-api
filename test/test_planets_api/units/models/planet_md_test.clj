...
(deftest test-get-total-films-by-planet
  (testing "test function get-total-films-by-planet"
    ...
    (is (= (#'planet-md/get-total-films-by-planet factory/planet-F) 2))
    (is (= (#'planet-md/get-total-films-by-planet factory/planet-G) 2))
    (is (= (#'planet-md/get-total-films-by-planet factory/planet-I) 2))
    (is (= (#'planet-md/get-total-films-by-planet factory/planet-J) 2))))
